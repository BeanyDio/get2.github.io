require(['vs/editor/editor.main', 'luaparse'], function (monaco, luaparse) {
    ...
    Supernal Executer - v3.0.0
    Made with 💜 by @SupernalRB
]]

print("Mayakovski Team!")`;
    ...
    function createNewTab() {
        ...
        const usedNumbers = Array.from(existingTabs)
            .map(tab => {
                const match = tab.textContent.match(/Tab-(\d+)/);
        ...
        tab.innerHTML = `Tab-${nextTabNumber}<span class="close-tab">x</span>`;
